...
SELECT 'rotation_trip_after_rebuild_v2', COUNT(*) FROM rotation_trip;
SELECT 'rotation_trip_dur_stats_v2', COUNT(*), MIN(end_ts-start_ts), AVG(end_ts-start_ts), MAX(end_ts-start_ts) FROM rotation_trip;
SELECT 'scan_pass_linked_v2', COUNT(*) FROM scan_pass WHERE rotation_trip_id IS NOT NULL;
