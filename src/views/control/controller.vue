        ...
        <el-tab-pane name="auto-mode">
          ...
          <div class="status_container">
            <div @click="toggleAutoMode" class="auto_status">
              <el-icon size="50" :style="{ color: store.apiAirRingData.IsAuto ? '#34e53a' : '', filter: store.apiAirRingData.IsAuto ? 'drop-shadow(0 0 5px rgba(30, 217, 39, 0.617)' : ''    }">
                <AutoIcon />
              </el-icon>
              <p>自动模式</p>
            </div>
            ...
            <div class="status_reset">
              <p><el-button :disabled="store.apiAirRingData.IsAuto" type="primary" :icon="ResetIcon"></el-button></p>
              <p>复位</p>
            </div>
          </div>
        </el-tab-pane>
