...
export class ADBoxClient extends EventEmitter {
  ...
  private handleResponse(payload: Buffer): void {
    ...
    if (
      this.currentReq &&
      this.matchPrefix(payload, this.currentReq.expectedPrefix)
    ) {
        ...
        resolve: (payload: Buffer) => {
          try {
            ...
            if (def.parse) resolve(def.parse(payload.subarray(dataStart)))
              ...
              resolve(customParse(payload.subarray(dataStart)))
  ...
  async getInput(): Promise<number> {
    return this.sendCommand(Commands.GET_IN)
  }
  ...
  async getOutput(): Promise<number> {
    return this.sendCommand(Commands.GET_OUT)
  }
  ...
  async getPos0(): Promise<number> {
    return this.sendCommand(Commands.GET_POS0)
  }
  ...
  async getPos1(): Promise<number> {
    return this.sendCommand(Commands.GET_POS1)
  }
   ...
   */
  async getPosAll() {
    return this.sendCommand(Commands.GET_POS_ALL)
  }
  ...
  async getSystemTick(): Promise<number> {
    return this.sendCommand(Commands.GET_TICK)
  }
   ...
   */
  async setRunParamSpeed(v: number): Promise<void> {
    await this.sendCommand(Commands.SET_V, u32le(v))
  }
  ...
  async setRunParamInitSpeed(sv: number): Promise<void> {
    await this.sendCommand(Commands.SET_SV, u32le(sv))
  }
  ...
  async setRunParamAccelTime(ms: number): Promise<void> {
    await this.sendCommand(Commands.SET_ACC, u32le(ms))
  }
  ...
  async setRunParamDecelTime(ms: number): Promise<void> {
    await this.sendCommand(Commands.SET_DEC, u32le(ms))
  }
   ...
   * @param s 速度值（pps）
   */
  async setRunParamHomeSpeed1(s: number): Promise<void> {
    await this.sendCommand(Commands.SET_H1, u32le(s))
  }
   ...
   * @param s 速度值（pps）
   */
  async setRunParamHomeSpeed2(s: number): Promise<void> {
    await this.sendCommand(Commands.SET_H2, u32le(s))
  }
  ...
  async getRunParamSpeed(): Promise<number> {
    return this.sendCommand(Commands.GET_V)
  }
  ...
  async getRunParamInitSpeed(): Promise<number> {
    return this.sendCommand(Commands.GET_SV)
  }
  ...
  async getRunParamAccelTime(): Promise<number> {
    return this.sendCommand(Commands.GET_ACC)
  }
  ...
  async getRunParamDecelTime(): Promise<number> {
    return this.sendCommand(Commands.GET_DEC)
  }
  ...
  async getRunParamHomeSpeed1(): Promise<number> {
    return this.sendCommand(Commands.GET_H1)
  }
  ...
  async getRunParamHomeSpeed2(): Promise<number> {
    return this.sendCommand(Commands.GET_H2)
  }
